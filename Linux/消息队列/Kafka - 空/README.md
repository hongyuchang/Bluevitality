...
#num.partitions=1                           #topic在当前Broker上的分片的数量（重要）
num.recovery.threads.per.data.dir=1         #segment文件默认会被保留7天，这里设置恢复和清理data下数据的线程数
...
zookeeper.connect=193.168.133.130:2181      #ZK的IP:PORT，格式：IP:PORT,IP:PORT,IP:PORT,...
